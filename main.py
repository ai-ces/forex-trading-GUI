...
def openTrade():
    global data, future, canvas, data_close_array, future_array, ax1,line2,canvas2,ax2,line3,canvas3,ax3,line4,canvas4,ax4
    print("OpenTrade")
    if item != "":
...
def update():
    ...
    if method.get() == "m1":
        if item == "EUR/USD":
            ...
            line.set_xdata(len(data_close_array))
            ...
            line3.set_xdata(len(data_close_array))
